 ...
 */
 function theme_options_css(){
		...
		$styles_output .= "header[role='banner']{background-color:".$header_styles['background_color'].";}header[role='banner'] a{color:".$header_styles['text_color'].";}header[role='banner'] a:hover{color:".$header_styles['text_hover_color'].";}header[role='banner'] .main-menu ul li a{color:".$header_styles['text_color'].";}header[role='banner'] .main-menu ul li a:hover{color:".$header_styles['text_hover_color'].";}header[role='banner'] .main-menu ul li:hover > a{color:".$header_styles['text_hover_color'].";}header[role='banner'] .menu-toggle{color:".$header_styles['text_color'].";}header[role='banner'] .menu-toggle .hamburger-inner,header[role='banner'] .menu-toggle .hamburger-inner::before,header[role='banner'] .menu-toggle .hamburger-inner::after{background:".$header_styles['text_color'].";}header[role='banner'] .menu-toggle:hover{color:".$header_styles['text_hover_color'].";}header[role='banner'] .menu-toggle:hover .hamburger-inner,header[role='banner'] .menu-toggle:hover .hamburger-inner::before,header[role='banner'] .menu-toggle:hover .hamburger-inner::after{background:".$header_styles['text_hover_color'].";}";

		// add sticky header styles
		$stickyscroll_behavior = get_field( 'stickyscroll_behavior', 'option' );
		if($stickyscroll_behavior == "sticky-scroll"):
			$sticky_header_styles = get_field( 'sticky_header_styles', 'option' );
			$styles_output .= "header[role='banner'].sticky,header[role='banner'].sticky-scroll.is-scrolling-up{background-color:".$sticky_header_styles['sticky_header_background_color'].";}header[role='banner'].sticky a,header[role='banner'].sticky-scroll.is-scrolling-up a{color:".$sticky_header_styles['sticky_header_text_color'].";}header[role='banner'].sticky a:hover,header[role='banner'].sticky-scroll.is-scrolling-up a:hover{color:".$sticky_header_styles['sticky_header_text_hover_color'].";}header[role='banner'].sticky .main-menu ul li a,header[role='banner'].sticky-scroll.is-scrolling-up .main-menu ul li a{color:".$sticky_header_styles['sticky_header_text_color'].";}header[role='banner'].sticky .main-menu ul li a:hover,header[role='banner'].sticky-scroll.is-scrolling-up .main-menu ul li a:hover{color:".$sticky_header_styles['sticky_header_text_hover_color'].";}header[role='banner'].sticky .main-menu ul li:hover > a,header[role='banner'].sticky-scroll.is-scrolling-up .main-menu ul li:hover > a{color:".$sticky_header_styles['sticky_header_text_hover_color'].";}header[role='banner'].sticky .menu-toggle,header[role='banner'].sticky-scroll.is-scrolling-up .menu-toggle{color:".$sticky_header_styles['sticky_header_text_color'].";}header[role='banner'].sticky .menu-toggle .hamburger-inner,header[role='banner'].sticky-scroll.is-scrolling-up .menu-toggle .hamburger-inner,header[role='banner'].sticky .menu-toggle .hamburger-inner::before,header[role='banner'].sticky-scroll.is-scrolling-up .menu-toggle .hamburger-inner::before,header[role='banner'].sticky .menu-toggle .hamburger-inner::after,header[role='banner'].sticky-scroll.is-scrolling-up .menu-toggle .hamburger-inner::after{background:".$sticky_header_styles['sticky_header_text_color'].";}header[role='banner'].sticky .menu-toggle:hover,header[role='banner'].sticky-scroll.is-scrolling-up .menu-toggle:hover{color:".$sticky_header_styles['sticky_header_text_hover_color'].";}header[role='banner'].sticky .menu-toggle:hover .hamburger-inner,header[role='banner'].sticky-scroll.is-scrolling-up .menu-toggle:hover .hamburger-inner,header[role='banner'].sticky .menu-toggle:hover .hamburger-inner::before,header[role='banner'].sticky-scroll.is-scrolling-up .menu-toggle:hover .hamburger-inner::before,header[role='banner'].sticky .menu-toggle:hover .hamburger-inner::after,header[role='banner'].sticky-scroll.is-scrolling-up .menu-toggle:hover .hamburger-inner::after{background:".$sticky_header_styles['sticky_header_text_hover_color'].";}";
		endif;
